...
var TCPCmd = &cobra.Command{
	Use:   "tcp <host:port>",
	Short: "Start kping in TCP client mode to send request to TCP kping server. Use: kping tcp <ipv4:port>",
	Long:  `kping is a test program written in go to verify RTT. This mode use a TCP connection `,
	Args: func(cmd *cobra.Command, args []string) error {
