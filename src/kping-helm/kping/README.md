...
The program can run as standalone on linux (x86/arm) and macOS, docker image or helm chart. For macOS and iOS GUI you must compile the app using xcode and install locally.
