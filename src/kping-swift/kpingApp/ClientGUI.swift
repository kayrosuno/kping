...
///// Para cliente QPing
//@MainActor
//func stopQClientGUI(appData: UIState) async
//{
...
//@MainActor
//func runQClientGUI(appData: UIState)  async throws -> Void {
//    
...
//)  -> Void {
//
//    let kpingAppData = UIState.shared
//    //    guard let kpingAppData = kpingAppData else {  print("\(TimeNow())clientGUIHandleReceiveData: Error no kpingAppData"); return }
//    //    
//    guard let cluster = kpingAppData.clusterRunning else {
//        print(
//            "\(TimeNow())clientGUIHandleReceiveData: Error no cluster no kpingAppData"
//        ); return
//    }
//
//    
...
//            kpingAppData.actualRTTns = rtt_time
//            
//            //Visualizar el rtt
//            kpingAppData.actualRTTns = rtt_time
//            if rtt_time > kpingAppData.maxRTTns { kpingAppData.maxRTTns = rtt_time }
//            if rtt_time < kpingAppData.minRTTns || kpingAppData.minRTTns == 0 { kpingAppData.minRTTns = rtt_time }
//           
//            //Media rtt
//            let nuevaCantidadNumeros = Double (cluster.kpingDataChart.count + 1)
//            kpingAppData.medRTTns = kpingAppData.medRTTns == 0 ? rtt_time :
//            ((kpingAppData.medRTTns * Double(cluster.kpingDataChart.count)) + rtt_time) / nuevaCantidadNumeros
//            
...
//    Task { await kpingAppData.qclient!.registerReceiveHandler(
...
//    
//    Task {
//    guard let cluster = kpingAppData.clusterRunning else {  print("PrintGUI: Error no kpingAppData"); return }
//
//        await cluster.kpingDataString.append(
//        RTTData(
//            string: cadena,
//            id: (kpingAppData.qclient?.kping?.print_id)!,
//            timeReceived: uptime(),
//            delay: 0.0
//        )
//    )
//    await kpingAppData.qclient?.kping!.incPrintId()
...
//    //Para loop
//    Task {
//        await kpingAppData.qclient?.kping!.setClientLoop(false)
//    }
//}
//
