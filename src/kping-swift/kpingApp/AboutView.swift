...
struct AboutView: View {
    ...
    @Environment(UIState.self) private var kpingAppData
    ...
    var body: some View {
        ...
        Text("")
        Text("Alejandro Garcia,  2024-2026")
        //Text("github/kayrosuno")
        Text("")
        Text("""
                 qping is a ping utility to test connection using UDP-QUIC protocol available in go and Swift.
                 ...
                 To **learn more**, *please* feel free to visit [Github page](https://github.com/kayrosuno/kping) for details.
                 
                 
                 """
        ).padding(20)
       
        Button("OK"){  kpingAppData.showAboutView = false}.padding(20).tint(.accentColor)
    }
}
